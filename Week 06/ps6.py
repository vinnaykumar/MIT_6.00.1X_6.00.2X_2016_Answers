...
class CiphertextMessage(Message):
    ...
    def decrypt_message(self):
        ...
        In this method, a Hit is when a decrypted word is in the wordlist.
        Meaning, it is a real word in the English language.
        '''
        # Taking the encrypted text
        word = self.message_text
        # Initial shift
        Shift = 0
        # This will catch all the hits
        HitList = []
        # This keeps track of all the shift
        ShiftList = []

        # Since counting of Shift starts from 0, it must end at 25
        # The total number of possible values of shift can only be 26
        while Shift < 26:
            # This is very important.
            # In every iteration, the shift must begin at 0
            Hits = 0
            # Applying the shiift and then splitting the message
        ...
        # Extracting Maximum hits
        MaxHits = max(Dict.keys())
        # Exctracting value associated with the Maximum hits
        # This value is the Selected Shift
        # This is the Shift that successfuly decrypts the most
        # Number of words in the message.
        SelShift = Dict[MaxHits]

        # Returning a Tuple of Selected Shift, and Decrypted Text
